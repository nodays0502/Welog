    ...
    constructor({ editor, element, view, tippyOptions = {}, shouldShow, }) {
        ...
        this.shouldShow = ({ state, from, to }) => {
            ...
            const isEmptyTextBlock = !doc.textBetween(from, to).length
                && Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* isTextSelection */ "f"])(state.selection);
    ...
    update(view, oldState) {
        ...
        (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
            getReferenceClientRect: () => {
                if (Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* isNodeSelection */ "e"])(state.selection)) {
                    const node = view.nodeDOM(from);
                    if (node) {
                        return node.getBoundingClientRect();
                    }
                }
                return Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* posToDOMRect */ "h"])(view, from, to);
            },
        });
        this.show();
    }
...
const Document = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* Node */ "c"].create({
    name: 'doc',
    topNode: true,
    content: 'block+',
});
...
class FloatingMenuView {
    ...
    update(view, oldState) {
        ...
        (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
            getReferenceClientRect: () => Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* posToDOMRect */ "h"])(view, from, to),
        });
        this.show();
    }
    show() {
...
const Paragraph = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* Node */ "c"].create({
    name: 'paragraph',
    priority: 1000,
    addOptions() {
        return {
    ...
    renderHTML({ HTMLAttributes }) {
        return ['p', Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* mergeAttributes */ "g"])(this.options.HTMLAttributes, HTMLAttributes), 0];
    },
    addCommands() {
        return {
...
const Text = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* Node */ "c"].create({
    name: 'text',
    group: 'inline',
});
...
class ReactNodeView extends _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* NodeView */ "d"] {
    mount() {
        const props = {
            editor: this.editor,
            node: this.node,
...
/*! exports used: Editor, Extension, Node, NodeView, isNodeSelection, isTextSelection, mergeAttributes, posToDOMRect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return NodeView; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return isNodeSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return isTextSelection; });
/* unused harmony export markInputRule */
/* unused harmony export markPasteRule */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return mergeAttributes; });
/* unused harmony export nodeInputRule */
/* unused harmony export pasteRulesPlugin */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return posToDOMRect; });
...
//# sourceMappingURL=vendors~main.b1487c965b267b12f738.hot-update.js.map