    ...
    constructor({ editor, element, view, tippyOptions = {}, shouldShow, }) {
        ...
        this.shouldShow = ({ state, from, to }) => {
            ...
            const isEmptyTextBlock = !doc.textBetween(from, to).length
                && Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* isTextSelection */ "e"])(state.selection);
    ...
    update(view, oldState) {
        ...
        (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
            getReferenceClientRect: () => {
                if (Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* isNodeSelection */ "d"])(state.selection)) {
                    const node = view.nodeDOM(from);
                    if (node) {
                        return node.getBoundingClientRect();
                    }
                }
                return Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* posToDOMRect */ "f"])(view, from, to);
            },
        });
        this.show();
    }
...
class FloatingMenuView {
    ...
    update(view, oldState) {
        ...
        (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
            getReferenceClientRect: () => Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* posToDOMRect */ "f"])(view, from, to),
        });
        this.show();
    }
    show() {
...
class ReactNodeView extends _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* NodeView */ "c"] {
    mount() {
        const props = {
            editor: this.editor,
            node: this.node,
...
/*! exports used: Editor, Extension, NodeView, isNodeSelection, isTextSelection, posToDOMRect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return NodeView; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return isNodeSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return isTextSelection; });
/* unused harmony export markInputRule */
/* unused harmony export markPasteRule */
/* unused harmony export mergeAttributes */
/* unused harmony export nodeInputRule */
/* unused harmony export pasteRulesPlugin */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return posToDOMRect; });
/* unused harmony export textInputRule */
/* unused harmony export textPasteRule */
/* unused harmony export textblockTypeInputRule */
/* unused harmony export wrappingInputRule */
...
//# sourceMappingURL=vendors~main.19d057c528a50f131baf.hot-update.js.map