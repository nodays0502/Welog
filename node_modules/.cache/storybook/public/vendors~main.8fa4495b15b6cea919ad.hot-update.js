    ...
    constructor({ editor, element, view, tippyOptions = {}, shouldShow, }) {
        ...
        this.shouldShow = ({ state, from, to }) => {
            ...
            const isEmptyTextBlock = !doc.textBetween(from, to).length
                && Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* isTextSelection */ "g"])(state.selection);
    ...
    update(view, oldState) {
        ...
        (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
            getReferenceClientRect: () => {
                if (Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* isNodeSelection */ "f"])(state.selection)) {
                    const node = view.nodeDOM(from);
                    if (node) {
                        return node.getBoundingClientRect();
                    }
                }
                return Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* posToDOMRect */ "k"])(view, from, to);
            },
        });
        this.show();
    }
...
class FloatingMenuView {
    ...
    update(view, oldState) {
        ...
        (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
            getReferenceClientRect: () => Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* posToDOMRect */ "k"])(view, from, to),
        });
        this.show();
    }
    show() {
...
const Highlight = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* Mark */ "c"].create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['mark', Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* mergeAttributes */ "j"])(this.options.HTMLAttributes, HTMLAttributes), 0];
    },
    addCommands() {
        return {
    ...
    addInputRules() {
        return [
            Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* markInputRule */ "h"])({
                find: inputRegex,
                type: this.type,
            }),
        ];
    ...
    addPasteRules() {
        return [
            Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* markPasteRule */ "i"])({
                find: pasteRegex,
                type: this.type,
            }),
        ];
...
const TaskItem = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* Node */ "d"].create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['li', Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* mergeAttributes */ "j"])(this.options.HTMLAttributes, HTMLAttributes, { 'data-type': 'taskItem' }), 0];
    },
    addKeyboardShortcuts() {
        const shortcuts = {
    ...
    addInputRules() {
        return [
            Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* wrappingInputRule */ "l"])({
                find: inputRegex,
                type: this.type,
                getAttributes: match => ({
...
const TaskList = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* Node */ "d"].create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['ul', Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__[/* mergeAttributes */ "j"])(this.options.HTMLAttributes, HTMLAttributes, { 'data-type': 'taskList' }), 0];
    },
    addCommands() {
        return {
...
/*! exports used: Editor, Extension, Mark, Node, NodeView, isNodeSelection, isTextSelection, markInputRule, markPasteRule, mergeAttributes, posToDOMRect, wrappingInputRule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* unused harmony export callOrReturn */
...
/* unused harmony export getExtensionField */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return isNodeSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return isTextSelection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return markInputRule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return markPasteRule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return mergeAttributes; });
/* unused harmony export nodeInputRule */
/* unused harmony export pasteRulesPlugin */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return posToDOMRect; });
/* unused harmony export textInputRule */
/* unused harmony export textPasteRule */
/* unused harmony export textblockTypeInputRule */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return wrappingInputRule; });
...
const clearNodes = () => ({ state, tr, dispatch }) => {
    ...
    ranges.forEach(range => {
        state.doc.nodesBetween(range.$from.pos, range.$to.pos, (node, pos) => {
            ...
            const targetLiftDepth = Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* liftTarget */ "i"])(nodeRange);
...
function selectionToInsertionEnd(tr, startLen, bias) {
    ...
    if (!(step instanceof prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* ReplaceStep */ "b"] || step instanceof prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* ReplaceAroundStep */ "a"])) {
        return;
    }
...
const splitBlock = ({ keepMarks = true } = {}) => ({ tr, state, dispatch, editor, }) => {
    ...
    if (selection instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_0__[/* NodeSelection */ "c"] && selection.node.isBlock) {
        if (!$from.parentOffset || !Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* canSplit */ "e"])(doc, $from.pos)) {
            return false;
        }
        if (dispatch) {
            if (keepMarks) {
    ...
    if (dispatch) {
        ...
        let types = atEnd && deflt
            ...
            : undefined;
        let can = Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* canSplit */ "e"])(tr.doc, tr.mapping.map($from.pos), 1, types);
        if (!types
            && !can
            && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* canSplit */ "e"])(tr.doc, tr.mapping.map($from.pos), 1, deflt ? [{ type: deflt }] : undefined)) {
            can = true;
            types = deflt
                ? [{
                        type: deflt,
...
const splitListItem = typeOrName => ({ tr, state, dispatch, editor, }) => {
    ...
    if (!Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* canSplit */ "e"])(tr.doc, $from.pos, 2)) {
        return false;
    }
    if (dispatch) {
    ...
    get plugins() {
        ...
        const allPlugins = extensions
            ...
            if (addKeyboardShortcuts) {
                ...
                const keyMapPlugin = Object(prosemirror_keymap__WEBPACK_IMPORTED_MODULE_6__[/* keymap */ "a"])(bindings);
...
class Editor extends EventEmitter {
     ...
     */
    createView() {
        this.view = new prosemirror_view__WEBPACK_IMPORTED_MODULE_5__[/* EditorView */ "a"](this.options.element, {
...
function wrappingInputRule(config) {
    return new InputRule({
        ...
        handler: ({ state, range, match }) => {
            ...
            const wrapping = blockRange && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* findWrapping */ "g"])(blockRange, config.type, attributes);
            if (!wrapping) {
                return null;
            }
            ...
            if (before
                ...
                && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* canJoin */ "d"])(tr.doc, range.from - 1)
...
function joinBackward(state, dispatch, view) {
  ...
  if (!$cut) {
    var range = $cursor.blockRange(), target = range && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* liftTarget */ "i"])(range);
...
function joinUp(state, dispatch) {
  ...
  if (nodeSel) {
    if (sel.node.isTextblock || !Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canJoin */ "d"])(state.doc, sel.from)) { return false }
    point = sel.from;
  } else {
    point = Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* joinPoint */ "h"])(state.doc, sel.from, -1);
...
function joinDown(state, dispatch) {
  ...
  if (sel instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_2__[/* NodeSelection */ "c"]) {
    if (sel.node.isTextblock || !Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canJoin */ "d"])(state.doc, sel.to)) { return false }
    point = sel.to;
  } else {
    point = Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* joinPoint */ "h"])(state.doc, sel.to, 1);
    if (point == null) { return false }
  }
  if (dispatch)
...
function lift(state, dispatch) {
  ...
  var $from = ref.$from;
  var $to = ref.$to;
  var range = $from.blockRange($to), target = range && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* liftTarget */ "i"])(range);
  if (target == null) { return false }
  if (dispatch) { dispatch(state.tr.lift(range, target).scrollIntoView()); }
  return true
}
...
function liftEmptyBlock(state, dispatch) {
  ...
  if ($cursor.depth > 1 && $cursor.after() != $cursor.end(-1)) {
    ...
    if (Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canSplit */ "e"])(state.doc, before)) {
...
function splitBlock(state, dispatch) {
  ...
  if (state.selection instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_2__[/* NodeSelection */ "c"] && state.selection.node.isBlock) {
    if (!$from.parentOffset || !Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canSplit */ "e"])(state.doc, $from.pos)) { return false }
  ...
  if (dispatch) {
    ...
    var can = Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canSplit */ "e"])(tr.doc, tr.mapping.map($from.pos), 1, types);
    if (!types && !can && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canSplit */ "e"])(tr.doc, tr.mapping.map($from.pos), 1, deflt && [{type: deflt}])) {
      types = [{type: deflt}];
      can = true;
    }
    if (can) {
...
function joinMaybeClear(state, $pos, dispatch) {
  ...
  if (!$pos.parent.canReplace(index, index + 1) || !(after.isTextblock || Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canJoin */ "d"])(state.doc, $pos.pos)))
    { return false }
  if (dispatch)
    { dispatch(state.tr
...
function deleteBarrier(state, $cut, dispatch) {
  ...
  if (canDelAfter &&
    ...
    if (dispatch) {
      ...
      var tr = state.tr.step(new prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* ReplaceAroundStep */ "a"]($cut.pos - 1, end, $cut.pos, end, new prosemirror_model__WEBPACK_IMPORTED_MODULE_1__[/* Slice */ "j"](wrap, 1, 0), conn.length, true));
      var joinAt = end + 2 * conn.length;
      if (Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canJoin */ "d"])(tr.doc, joinAt)) { tr.join(joinAt); }
      dispatch(tr.scrollIntoView());
    }
    return true
  }
  ...
  var range = selAfter && selAfter.$from.blockRange(selAfter.$to), target = range && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* liftTarget */ "i"])(range);
  ...
  if (canDelAfter && textblockAt(after, "start", true) && textblockAt(before, "end")) {
    ...
    if (at.canReplace(at.childCount, at.childCount, afterText.content)) {
      if (dispatch) {
        ...
        var tr$1 = state.tr.step(new prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* ReplaceAroundStep */ "a"]($cut.pos - wrap$1.length, $cut.pos + after.nodeSize,
...
function wrapIn(nodeType, attrs) {
  return function(state, dispatch) {
    ...
    var $from = ref.$from;
    var $to = ref.$to;
    var range = $from.blockRange($to), wrapping = range && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* findWrapping */ "g"])(range, nodeType, attrs);
...
function wrapDispatchForJoin(dispatch, isJoinable) {
  return function (tr) {
    ...
    for (var i$2 = joinable.length - 1; i$2 >= 0; i$2--) {
      if (Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canJoin */ "d"])(tr.doc, joinable[i$2])) { tr.join(joinable[i$2]); }
    }
    dispatch(tr);
  }
}
...
"use strict";
/* unused harmony export keydownHandler */
...
function wrapInList(listType, attrs) {
  return function(state, dispatch) {
    ...
    var wrap = Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* findWrapping */ "g"])(outerRange, listType, attrs, range);
...
function doWrapInList(tr, range, wrappers, joinBefore, listType) {
  ...
  tr.step(new prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* ReplaceAroundStep */ "a"](range.start - (joinBefore ? 2 : 0), range.end, range.start, range.end,
  ...
  for (var i$2 = range.startIndex, e = range.endIndex, first = true; i$2 < e; i$2++, first = false) {
    if (!first && Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canSplit */ "e"])(tr.doc, splitPos, splitDepth)) {
...
function splitListItem(itemType) {
  return function(state, dispatch) {
    ...
    if (!Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* canSplit */ "e"])(tr.doc, $from.pos, 2, types)) { return false }
...
function liftToOuterList(state, dispatch, itemType, range) {
  ...
  if (end < endOfList) {
    ...
    tr.step(new prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* ReplaceAroundStep */ "a"](end - 1, endOfList, end, endOfList,
  ...
  dispatch(tr.lift(range, Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* liftTarget */ "i"])(range)).scrollIntoView());
  return true
}
...
function liftOutOfList(state, dispatch, range) {
  ...
  tr.step(new prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* ReplaceAroundStep */ "a"](start - (atStart ? 1 : 0), end + (atEnd ? 1 : 0), start + 1, end - 1,
...
function sinkListItem(itemType) {
  return function(state, dispatch) {
    ...
    if (dispatch) {
      ...
      dispatch(state.tr.step(new prosemirror_transform__WEBPACK_IMPORTED_MODULE_0__[/* ReplaceAroundStep */ "a"](before - (nestedBefore ? 3 : 1), after,
...
function selectionToInsertionEnd(tr, startLen, bias) {
  ...
  if (!(step instanceof prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* ReplaceStep */ "b"] || step instanceof prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* ReplaceAroundStep */ "a"])) { return }
...
var Transaction = /*@__PURE__*/(function (Transform) {
  ...
  return Transaction;
}(prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__[/* Transform */ "c"]));
...
/*! exports used: ReplaceAroundStep, ReplaceStep, Transform, canJoin, canSplit, dropPoint, findWrapping, joinPoint, liftTarget */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReplaceAroundStep; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ReplaceStep; });
/* unused harmony export Step */
/* unused harmony export StepMap */
/* unused harmony export StepResult */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return Transform; });
/* unused harmony export TransformError */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return canJoin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return canSplit; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return dropPoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return findWrapping; });
/* unused harmony export insertPoint */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return joinPoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return liftTarget; });
...
/*! exports used: EditorView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export Decoration */
/* unused harmony export DecorationSet */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditorView; });
...
editHandlers.drop = function (view, e) {
  ...
  e.preventDefault();
  var insertPos = slice ? Object(prosemirror_transform__WEBPACK_IMPORTED_MODULE_2__[/* dropPoint */ "f"])(view.state.doc, $mouse.pos, slice) : $mouse.pos;
...
//# sourceMappingURL=vendors~main.8fa4495b15b6cea919ad.hot-update.js.map